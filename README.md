...
[![Build by GCC(gfortran) on Linux/macOS](https://github.com/odav/sp-scratch/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/odav/sp-scratch/actions/workflows/build.yml)
